...
2. One home per fact. Restated content becomes a pointer. Exception: a
   one-line restatement that saves the reader a file hop. Flag facts that
   exist ONLY in the wrong doc; those get MOVED to the owner, never deleted.
